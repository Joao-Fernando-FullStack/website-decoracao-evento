...
<table id="pending" class="table table-striped table-bordered table-hover table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($pagamento as $pagamentos) : ?>      
        <tr>
            ...
            <td class=""><?= $pagamentos->cliente;?></td>
            <td class=""><?= $pagamentos->total;?></td>
            <td class=""><?= $pagamentos->tipo_pagamento;?></td>
            <td class=""><?= $pagamentos->descricao;?></td>
            <td class=""><?= $pagamentos->data;?></td>          
                <?php
                if($pagamentos->estado =='aprovado'){
                    echo "<td style='color: green; font-weight: bolder;'>
                    aprovado
                    </td>";
                }else{
                    echo "<td style='color: red; font-weight: bolder;'>
                    pendente
                    </td>";
                }
...
<table id="confirmed" class="table table-striped table-bordered table-hover table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($pagamento1 as $pagamentos1) : ?>      
        <tr>
            ...
            <td class=""><?= $pagamentos1->cliente;?></td>
            <td class=""><?= $pagamentos1->tipo;?></td>
            <td class=""><?= $pagamentos1->data_evento;?></td>
            <td class=""><?= $pagamentos1->total;?></td>
            <td class=""><?= $pagamentos1->cadeiras;?></td>
            <td class=""><?= $pagamentos1->tipo_pagamento;?></td>
            <td class=""><?= $pagamentos1->localizacao;?></td>
            <td class=""><?= $pagamentos1->cor;?></td>
            <td class=""><?= $pagamentos1->estilo;?></td>
            <td class=""><?= $pagamentos1->data;?></td>          
                <?php
        ...
        <div class="modal-content">
            ...
            <form id="editEstadoForm" action=" " method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button name="eliminar" class="btn btn-danger btn-sm active" title="Apagar cliente"><i class="mdi mdi-delete"></i>Apagar</a></button>
                </div>
                </div>
            </form>
        </div>
