...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect_to("pagamento.php?total=".$totalCarrinho."&produto=".$produto);
}
?>
<!doctype html>
<html lang="pt">
        ...
        carrinho.forEach(item => {
            ...
            carrinhoItems.innerHTML += `
                <tr>
                    ...
                    <td>${item.preco}</td>
                    <td><input type="number" value="${item.quantidade}" maxlength="4" size="10" style="width: 70px;" min="0" max="100" class="form-control quantidade" data-id="${item.id}"></td>
                    <td>${itemTotal}</td>
