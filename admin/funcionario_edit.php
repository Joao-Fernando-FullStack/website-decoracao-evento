            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="btn-group mr-2">
                        ...
                        <option value="Gerente" <?php echo ($funcionario->funcao == 'Gerente') ? 'selected' : ''; ?>>Gerente</option>
                        <option value="Decorador" <?php echo ($funcionario->funcao == 'Decorador') ? 'selected' : ''; ?>>Decorador</option>
